...
const custom_truthiness = (value: TruthyValue): boolean => {
...
exports.formatAPDU = (value: TruthyValue): Buffer => Buffer.from([custom_truthiness(value) ? 1:0]);
...
exports.subtypes = {
  ...
  100: {
    ...
    name: 'DPT_Heat/Cool',
    desc: 'heat/cool',
    enc: {0: 'cooling', 1: 'heating'}, //@zhri fix the object values acording to https://www.knx.org/wAssets/docs/downloads/Certification/Interworking-Datapoint-types/03_07_02-Datapoint-Types-v02.02.01-AS.pdf
  },
};
